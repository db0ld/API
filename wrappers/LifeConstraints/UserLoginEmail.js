...
/**
 * UserLoginEmail. class for constraints
 *
 * @class UserLoginEmail.
 * @constructor
 */
var UserLoginEmail = function (key, required, allow_self, throw_404) {
...
UserLoginEmail.prototype = new Abstract();
UserLoginEmail.prototype.constructor = Abstract;

UserLoginEmail.prototype.doc = function () {
    return 'User Login or E-mail';
};
 ...
 * @method
 */
UserLoginEmail.prototype.validate = function (validator, cb) {
 ...
 * @method
 */
UserLoginEmail.prototype.sanitize = function (validator, cb) {
    var that = this;
